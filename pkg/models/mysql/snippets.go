...
func (m *SnippetModel) Get(id int) (*models.Snippet, error) {
	...
	if err != nil {
		...
		// instead.
		// Aside: You might be wondering why we’re returning the models.ErrNoRecord error
		// instead of sql.ErrNoRows directly. The reason is to help encapsulate the model completely,
		// so that our application isn’t concerned with the underlying datastore or reliant on
